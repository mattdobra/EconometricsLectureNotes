...
```
We see that the biggest diamond in the data set was only 5.01 carats.  This prediction is beyond the scope of the model, as the prediction is trying to estimate a point outside of the range of the sample data.  This is called *extrapolation* and is generally frowned upon.  
