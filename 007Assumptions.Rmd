...
Another common non-linear transformation is the quadratic transformation; this is particularly useful in cases where you thinka relationship may be decreasing up to a point, and then start increasing after that point (or vice versa).  To see this in action, let's look at a graph that looks at the relationship between the age and selling prices of homes in the `hprice3` data from the `wooldridge` package.
